...
-- Define tags table.
tags = {
  layout = {layouts[2], layouts[7], layouts[7], layouts[7], layouts[7], layouts[7], layouts[7], layouts[7], layouts[8]}
}
...
awful.rules.rules = {
  ...
  { rule = { class = "Pidgin", role = "conversation" }, properties = { floating = true } },
