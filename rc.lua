...
-- Define tags table.
tags = {
  layout = {layouts[4], layouts[6], layouts[6], layouts[6], layouts[6], layouts[6], layouts[6], layouts[6], layouts[8]}
}
...
awful.rules.rules = {
  ...
  { rule = { class = "FloatingUXterm" }, properties = { floating = true, ontop = true, skip_taskbar = true}, callback = function(c) awful.placement.under_mouse(c); awful.placement.no_offscreen(c); end },
  ...
  { rule = { class = "Iceweasel Preferences" }, properties = { floating = true, skip_taskbar = true } },
